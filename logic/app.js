...
var keyboardMap = layoutMaps['canaria'];
var letterDictionary = levelDictionaries['canaria'];
var currentLayout = localStorage.getItem('currentLayout') || 'canaria';
...
function updateLayoutUI() {
	switch (currentKeyboard) {
		case 'ansi':
			...
			layoutMaps.canaria.KeyZ = 'x';
			layoutMaps.canaria.KeyX = 'v';
			layoutMaps.canaria.KeyC = 'd';
			layoutMaps.canaria.KeyV = 'g';
			layoutMaps.canaria.KeyB = 'q';
			layoutMaps.canaria.KeyN = 'm';
			layoutMaps.canaria.KeyG = 'b';
			layoutMaps.canaria.KeyH = 'f';
			layoutMaps.canaria.KeyT = 'k';
			layoutMaps.canaria.KeyU = 'j';
			break;
		case 'iso':
			document.querySelector('.cheatsheet').innerHTML = isoDivs;
			layoutMaps.canaria.IntlBackslash = 'q';
			layoutMaps.canaria.KeyZ = 'x';
			layoutMaps.canaria.KeyX = 'v';
			layoutMaps.canaria.KeyC = 'd';
			layoutMaps.canaria.KeyV = 'g';
			delete layoutMaps.canaria.KeyB;
			layoutMaps.canaria.KeyN = 'm';
			layoutMaps.canaria.KeyG = 'b';
			layoutMaps.canaria.KeyH = 'f';
			layoutMaps.canaria.KeyT = 'k';
		...
		case 'ortho':
			...
			layoutMaps.canaria.KeyZ = 'x';
			layoutMaps.canaria.KeyX = 'j';
			layoutMaps.canaria.KeyC = 'v';
			layoutMaps.canaria.KeyV = 'd';
			layoutMaps.canaria.KeyB = 'k';
			layoutMaps.canaria.KeyN = 'x';
			layoutMaps.canaria.KeyG = 'g';
			layoutMaps.canaria.KeyH = 'm';
			layoutMaps.canaria.KeyT = 'b';
			layoutMaps.canaria.KeyU = 'j';
			break;
	}
